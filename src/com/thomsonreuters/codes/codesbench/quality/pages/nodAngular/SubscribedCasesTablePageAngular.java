...
@Component
public class SubscribedCasesTablePageAngular extends TablePageAngular
{

    @Autowired
    public SubscribedCasesTablePageAngular(WebDriver driver)
    {
        super(driver);
        this.driver = driver;
    }
    ...
    public  void clickOnHyperLinkOnFirstRow()
    {
        Table table = casesTablePage().parseCertainRows(0);
        TableCell cell = table.getCellByRowAndColumn(0, TableColumns.CASE_SERIAL_SUBSCRIBED_CASES);
        cell.doubleClick();
    ...
    public HashMap<Object, Integer> getColumnOrderWithScrolling()
    {
        HashMap<String, Integer> map1 = getActualColumnOrder();
        subscribedCasesPageAngular().scrollToRight("500");
        HashMap<String, Integer> map2 = getActualColumnOrder();
        HashMap<Object, Integer> map3 = new LinkedHashMap<>();
        map3.putAll(map1);
        map3.putAll(map2);
        map3 = HashMapUtilities.sortByValueLowToHigh(map3);
        return map3;
    }
}