...
@Component
public class NoTeamReportPopupAngular extends ReportPopupAngular {

    private final WebDriver driver;

    @Autowired
    public NoTeamReportPopupAngular(WebDriver driver) {
        super(driver);
        this.driver = driver;
    }
    ...
    @PostConstruct
    public void init() {
        PageFactory.initElements(driver, NoTeamReportPopupElementsAngular.class);
    }
