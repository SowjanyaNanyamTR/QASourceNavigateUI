...
public class SourceNavigateContextMenuElements
{

    private static final String CONTEXT_MENU = "//div[@id='contextMenu']";
    public static final String EDIT = CONTEXT_MENU + "//a[text()='Edit']";
