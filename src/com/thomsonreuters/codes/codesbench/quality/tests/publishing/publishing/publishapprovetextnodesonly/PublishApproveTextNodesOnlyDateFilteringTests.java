...
public class PublishApproveTextNodesOnlyDateFilteringTests extends TestService
{
    ...
    {
        //NOTE: if this test does not pass go in and change the dates correctly for clean up. -> notes on what they were at the time of test creation are next to the variables
        ...
        try
        {
            ...
            hierarchySearchPage().searchContentUuid(contentUuid3);
            if (!siblingMetadataPage().isSelectedNodeNotPublished()) {
                siblingMetadataPage().setNotPublishedStatusForSelectedNode();
            }
