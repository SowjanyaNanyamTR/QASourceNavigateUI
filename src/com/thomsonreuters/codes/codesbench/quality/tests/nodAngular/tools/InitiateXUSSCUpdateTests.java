...
public class InitiateXUSSCUpdateTests extends TestService
{
     ...
     * and then click "Initiate XUSSC Update" from the Tools section
     * 3. VERIFY: Initiate XUSSC Update window opened
     * 4. VERIFY the following elemnts are present:
     * a) "Update US Supreme Court Features" heading
     ...
     * 5. Click "Cancel"
     * 6. VERIFY: Initiate XUSSC Update window closed
     */
    @Test
    @EDGE
    @LEGAL
    @LOG
    public void initiateXUSSCUpdateLayoutTest()
    {
        String expectedStatus = "Update US Supreme Court Features";
        ...
        //and then click "Initiate XUSSC Update" from the Tools section
        homePageAngular().clickInitiateXUSSCUpdate();
        // VERIFY: Initiate NOD Update window opened
        Assertions.assertTrue(initiateXUSSCUpdatePopupAngular().doesElementExist(InitiateXUSSCUpdatePopupsElementsAngular.PAGE_TITLE), "Initiate XUSSC Update window DID NOT open");
        //4. VERIFY the following elements are present:
        String actualStatus = initiateXUSSCUpdatePopupAngular().getStatus();
        String actualCurrentUserName = initiateXUSSCUpdatePopupAngular().getCurrentUserName();
        boolean isSourceTagDisplayed = initiateXUSSCUpdatePopupAngular().isSourceTagDisplayed();
        boolean isFileNameDisplayed = initiateXUSSCUpdatePopupAngular().isFileNameDisplayed();
        ...
        Assertions.assertAll(
                ...
                () -> Assertions.assertFalse(homePageAngular().doesElementExist(InitiateXUSSCUpdatePopupsElementsAngular.PAGE_TITLE), "Initiate XUSSC Update window DID NOT close")
        );
    }
     ...
     * HALCYONST-10605
     * 1. Log onto the Iowa (development) content set
     * 2. Go to NOD -> Subscribed Cases - angular, then click "Home" in the header on the top of the page, and then click "Initiate XUSSC Update" from the Tools section
     * 3. VERIFY: Initiate XUSSC Update window opened
    ...
    @LEGAL
    @LOG
    public void initiateXUSSCUpdateFilterSelectAllTest()
    {
        ...
        homePageAngular().openNodHomePage(ContentSets.IOWA_DEVELOPMENT);
        loginPage().logIn();
        //2. click "Initiate XUSSC Update" from the Tools section
        homePageAngular().clickInitiateXUSSCUpdate();
        // VERIFY: Initiate NOD Update window opened
        Assertions.assertTrue(initiateXUSSCUpdatePopupAngular().doesElementExist(InitiateXUSSCUpdatePopupsElementsAngular.PAGE_TITLE), "Initiate XUSSC Update window DID NOT open");
        //4. Click in "File name" field and type there something like TEST_001
        initiateXUSSCUpdatePopupAngular().setFileName(fileName);
        //5. In filter field above the non-selected volumes column type "constitution"
    ...
    @LEGAL
    @LOG
    public void initiateXUSSCUpdateWorkflowTest() // Test failed due to workflow in old and new NOD can't work on the same time and now it is turned of on NODAngular
    {
        String fileName = "TEST_001";
        String sourceTag = "15";
        String firstVolume = "0030";
        ...
        initiateXUSSCUpdatePopupAngular().setFileName(fileName);
        //5. Click in "Source tag" field and type there "15"
        initiateXUSSCUpdatePopupAngular().setSourceTag(sourceTag);
        //6. Select volumes 0030, 0050 and 0330 from Non-Selected Volumes column
        ...
        //9. VERIFY: Workflow is created and hyperlink is provided
        String actualMessage = initiateXUSSCUpdatePopupAngular().getMessage();
    ...
    @LEGAL
    @LOG
    public void initiateXUSSCUpdateWorkflowWithEmptyFieldTest() // Test failed due to workflow in old and new NOD can't work on the same time and now it is turned of on NODAngular
    {
        String sourceTag = "15";
        String firstVolume = "0030";
        String secondVolume = "0050";
        ...
        //8. Remove source tag
        initiateXUSSCUpdatePopupAngular().clearSourceTag();
        //9. VERIFY: "Create Workflow" button is disabled
