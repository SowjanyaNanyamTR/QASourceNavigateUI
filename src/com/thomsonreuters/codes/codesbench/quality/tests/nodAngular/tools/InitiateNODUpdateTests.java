...
public class InitiateNODUpdateTests extends TestService
{
    /**
     * HALCYONST-10596
     ...
     * and then click "Initiate NOD Update" from the Tools section
     * 3.  VERIFY: Initiate NOD Update window opened
     * 4. VERIFY the following elements are present:
     * a) "Updates NOD case history and topic & key." heading
     ...
     * i)  "Create NOD Update Compare Test" button is disabled
     * k) "Create Workflow" button is disabled
     * l) "Create CWB Workflow" button is disabled
     * m) "Cancel" button is enabled
     * 5. Click "Cancel"
     * 6. VERIFY: Initiate NOD Update window closed
     */
    @Test
    @EDGE
    @LEGAL
    @LOG
    public void initiateNODUpdateLayoutTest()
    {
        String expectedStatus = "Updates NOD case history and topic & key.";
        ...
        //and then click "Initiate NOD Update" from the Tools section
        homePageAngular().clickInitiateNODUpdate();
        // VERIFY: Initiate NOD Update window opened
        Assertions.assertTrue(initiateNODUpdatePopupAngular().doesElementExist(InitiateNODUpdatePopupElementsAngular.PAGE_TITLE), "Initiate NOD Update window DID NOT open");
        //4. VERIFY the following elements are present:
        String actualStatus = initiateNODUpdatePopupAngular().getStatus();
        String actualCurrentUserName = initiateNODUpdatePopupAngular().getCurrentUserName();
        boolean isSourceTagDisplayed = initiateNODUpdatePopupAngular().isSourceTagDisplayed();
        boolean isFileNameDisplayed = initiateNODUpdatePopupAngular().isFileNameDisplayed();
        ...
        Assertions.assertAll(
                ...
                () -> Assertions.assertFalse(homePageAngular().doesElementExist(InitiateNODUpdatePopupElementsAngular.PAGE_TITLE), "Initiate NOD Update window DID NOT close")
        );
    }
     ...
     * HALCYONST-10596
     * 1. Log onto the Iowa (development) content set
     * 2. Go to NOD -> Subscribed Cases - angular, then click "Home" in the header on the top of the page, and then click "Initiate NOD Update" from the Tools section
     * 3.  VERIFY: Initiate NOD Update window opened
     ...
     * 20. In filter field above the non-selected volumes column type "03"
     ...
     * 28. VERIFY: Only volumes containing the pattern "art" should occur, such as volumes containg "part", "arts", or simply "art"
    ...
    @LEGAL
    @LOG
    public void initiateNODUpdateFilterSelectAllTest()
    {
        ...
        homePageAngular().openNodHomePage(ContentSets.IOWA_DEVELOPMENT);
        loginPage().logIn();
        //2. click "Initiate NOD Update" from the Tools section
        homePageAngular().clickInitiateNODUpdate();
        //3. VERIFY: Initiate NOD Update window opened
        Assertions.assertTrue(initiateNODUpdatePopupAngular().doesElementExist(InitiateNODUpdatePopupElementsAngular.PAGE_TITLE), "Initiate NOD Update window DID NOT open");
        //4. Click in "File name" field and type there something like TEST_001
        initiateNODUpdatePopupAngular().setFileName(fileName);
        //5. In filter field above the non-selected volumes column type "constitution"
    ...
    @LEGAL
    @LOG
    public void initiateNODUpdateWorkflowTest() // Test failed due to workflow in old and new NOD can't work on the same time and now it is turned of on NODAngular
    {
        String fileName = "TEST_001";
        String sourceTag = "15";
        String firstVolume = "0030";
        ...
        initiateNODUpdatePopupAngular().setFileName(fileName);
        //5. Click in "Source tag" field and type there "15"
        initiateNODUpdatePopupAngular().setSourceTag(sourceTag);
        //6. Select volumes 0030, 0050 and 0330 from Non-Selected Volumes column
        ...
        //9. VERIFY: Workflow is created and hyperlink is provided
        String actualMessage = initiateNODUpdatePopupAngular().getMessage();
     ...
     * HALCYONST-10596
     * 1. Log onto the Iowa (development) content set
     * 2. 2. Go to NOD -> Subscribed Cases - angular, then click "Home" in the header on the top of the page, and then click "Initiate NOD Update" from the Tools section
     * 3. VERIFY: Initiate NOD Update window opened
    ...
    @LEGAL
    @LOG
    public void initiateNODUpdateWorkflowWithEmptyFieldTest() // Test failed due to workflow in old and new NOD can't work on the same time and now it is turned of on NODAngular
    {
        String sourceTag = "15";
        String firstVolume = "0030";
        String secondVolume = "0050";
        ...
        //8. Remove source tag
        initiateNODUpdatePopupAngular().clearSourceTag();
        //9. VERIFY: "Create Workflow" button is disabled
