...
public class SourceNavigateAngularAssertions extends SourceNavigateAngularBase {
    ...
    public void assertThatProposedApprovedTrackingInformationInputFieldsAreReadOnly(String input) {
        assertThatAllInputFieldsAreReadOnly(input);
    }
    ...
    public void assertThatAllInputFieldsAreReadOnly(String element) {
        List<WebElement> dateFields = sourceNavigateAngularPage().getElements(element);
