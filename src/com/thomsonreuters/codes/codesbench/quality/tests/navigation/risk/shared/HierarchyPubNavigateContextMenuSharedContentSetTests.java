...
public class HierarchyPubNavigateContextMenuSharedContentSetTests extends TestService
{
	
	/**
	 * STORY/BUG - n/a <br>
	 * SUMMARY - This test verifies that the Risk user has the correct context menu options when right clicking a node in the Sibling Metadata pane on the Hierarchy Edit (PUB) page<br>
	 * USER - Risk <br>
	 */
	@Test
	@IE_EDGE_MODE
	@RISK
	@LOG
    public void siblingMetadataContextMenuOptionsRiskTest() 
    {
		String iowaContentSet = "Iowa (Development)";
		String nodeUuid = "I758D0DB00EDA11DCA306AC74CECB5275";
        ...
        (
        		...
        		() -> Assertions.assertFalse(queriesContextMenuOptionIsDisplayed, "The 'Queries' context menu option appeared when it should not have"),
	...
	/**
	 * STORY/BUG - n/a <br>
	 * SUMMARY - This test verifies that the Risk user has the correct context menu options when right clicking a node in the Hierarchy tree pane on the Hierarchy Edit (PUB) page<br>
	 * USER - Risk <br>
	 */
	@Test
	@IE_EDGE_MODE
	@RISK
	@LOG
    public void navigationPaneContextMenuOptionsRiskTest() 
    {
		String iowaContentSet = "Iowa (Development)";
		String nodeUuid = "I758D0DB00EDA11DCA306AC74CECB5275";
        ...
        boolean manageGlossaryTermsContextMenuOptionIsDisplayed = treeContextMenu().isElementDisplayed(TreeContextMenuElements.MANAGE_GLOSSARY_TERMS);
	...
	/**
	 * STORY/BUG - n/a <br>
	 * SUMMARY - This test verifies that the Risk user has the correct context menu options when right clicking a node in the Disposition/Derivation pane on the Hierarchy Edit (PUB) page<br>
	 * USER - Risk <br>
	 */
	@Test
	@IE_EDGE_MODE
	@RISK
	@LOG
    public void dispositionDerivationContextMenuOptionsRiskTest()
    {
		String iowaContentSet = "Iowa (Development)";
		String nodeUuid = "I758D0DB00EDA11DCA306AC74CECB5275";
	...
	/**
	 * STORY/BUG - n/a <br>
	 * SUMMARY - This test verifies that the Risk user has the correct context menu options when right clicking a node in the Parentage graph pane on the Hierarchy Edit (PUB) page<br>
	 * USER - Risk <br>
	 */
	@Test
	@IE_EDGE_MODE
	@RISK
	@LOG
    public void parentageGraphContextMenuOptionsRiskTest()
    {
		String iowaContentSet = "Iowa (Development)";
		String nodeUuid = "I758D0DB00EDA11DCA306AC74CECB5275";
        ...
        boolean viewMetadataContextMenuOptionIsDisplayed = parentageGraphContextMenu().isElementDisplayed(ParentageGraphContextMenuElements.REFRESH_SELECTION);
