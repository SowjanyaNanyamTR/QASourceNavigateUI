...
public class HierarchyDateSearchMultipleDocumentsLegalTests extends TestService
{
    /**
    ...
    @LEGAL
    @LOG
    public void hierarchyDateSearchClickSubmitNoDataInputLegalTest()
    {
    ...
    @LEGAL
    @LOG
    public void hierarchyDateSearchFileReportNameLengthLimitLegalTest()
    {
    ...
    @LEGAL
    @LOG
    public void hierarchyDateSearchSetRadioButtonNoInputLegalTest()
    {
     ...
     * SUMMARY - This test updates specific metadata values,
    ...
    @LEGAL
    @LOG
    public void hierarchyDateSearchingSingleContentSetReportLegalTest(String metadata)
    {
        ArrayList<String> nodeUuids = new ArrayList<>();
        nodeUuids.add("I091FB37014F011DA8AC5CD53670E6B4E");
        nodeUuids.add("I0924BC8014F011DA8AC5CD53670E6B4E");
        nodeUuids.add("I0929777014F011DA8AC5CD53670E6B4E");
        nodeUuids.add("I092DE44014F011DA8AC5CD53670E6B4E");
        nodeUuids.add("I0932511014F011DA8AC5CD53670E6B4E");
            ...
            for (String uuid : nodeUuids)
            {
                switch (metadata)
                {
                    ...
                    case "Date range: Start Date":
                        originalMetadataValues.add(DateAndTimeUtils.convertDateToFormat(HierarchyDatabaseUtils.getLegisEffectiveStartDate(uuid, connection),
                                DateAndTimeUtils.ddDashMMMdashYY_DATE_TIME_FORMAT));
                        contentUuid = HierarchyDatabaseUtils.getContentUuidWithNodeUuid(uuid, connection);
...
//                        originalMetadataValues.add(DateAndTimeUtils.convertDateToFormat(HierarchyDatabaseUtils.getLegisEffectiveEndDate(uuid, connection),
//                                DateAndTimeUtils.ddDashMMMdashYY_DATE_TIME_FORMAT));
                        contentUuid = HierarchyDatabaseUtils.getContentUuidWithNodeUuid(uuid, connection);
                        metadataUpdate = DateAndTimeUtils.getCurentDateDDDashMMMDashYY();
                    ...
                    case "Modified Date":
                        ...
                        originalMetadataValues.add(HierarchyDatabaseUtils.getModifiedDate(uuid, connection));
                        contentUuid = HierarchyDatabaseUtils.getContentUuidWithNodeUuid(uuid, connection);
                        HierarchyDatabaseUtils.updateModifiedDate(contentUuid, updatedDate, connection);
                        break;
                    case "Modified By":
                        originalMetadataValues.add(HierarchyDatabaseUtils.getModifiedBy(uuid, connection));
                        HierarchyDatabaseUtils.updateModifiedBy(uuid, prodLegalUser().getUsername(), connection);
                        break;
                    default:
            ...
            ArrayList<String> workflowID = hierarchyDateSearchMultipleDocumentsPage().getWorkflowIDs();
            homePage().switchToPage();
            toolsMenu().goToWorkflowReportingSystem();

            workflowSearchPage().setWorkflowID(workflowID.get(0));
            ...
            Assertions.assertTrue(reportAppears, "The expected Hierarchy Searching Report appeared");
            ...
            boolean doNodeUuidsAppearInExcelReport = nodeUuidsInReport.containsAll(nodeUuids);
            Assertions.assertTrue(doNodeUuidsAppearInExcelReport, "All node uuids appeared in the excel report as expected");
        }
        //Cleanup starts here
        finally
        {
...
//                        HierarchyDatabaseUtils.updateLegisEndEffectiveDate(contentUuid, originalMetadataValues.remove(), connection);
                    ...
                    case "Modified By":
                        HierarchyDatabaseUtils.updateModifiedBy(uuid, originalMetadataValues.remove(), connection);
                        break;
                    default:
