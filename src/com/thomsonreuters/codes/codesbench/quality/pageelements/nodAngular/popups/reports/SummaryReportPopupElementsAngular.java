...
public class SummaryReportPopupElementsAngular extends ReportPopupElementsAngular{

    public static final String PAGE_TITLE = "//div/h5[contains(text(), 'Summary Report')]";
